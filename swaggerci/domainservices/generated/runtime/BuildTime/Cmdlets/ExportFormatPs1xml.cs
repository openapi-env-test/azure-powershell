...
namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support";
