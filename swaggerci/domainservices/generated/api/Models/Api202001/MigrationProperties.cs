namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001
{
    ...
    public partial class MigrationProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IMigrationProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IMigrationPropertiesInternal
    {

        /// <summary>Internal Acessors for MigrationProgress</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IMigrationProgress Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IMigrationPropertiesInternal.MigrationProgress { get => (this._migrationProgress = this._migrationProgress ?? new Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.MigrationProgress()); set { {_migrationProgress = value;} } }

        /// <summary>Internal Acessors for OldSubnetId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IMigrationPropertiesInternal.OldSubnetId { get => this._oldSubnetId; set { {_oldSubnetId = value;} } }

        /// <summary>Internal Acessors for OldVnetSiteId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IMigrationPropertiesInternal.OldVnetSiteId { get => this._oldVnetSiteId; set { {_oldVnetSiteId = value;} } }

        /// <summary>Backing field for <see cref="MigrationProgress" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IMigrationProgress _migrationProgress;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IMigrationProgress MigrationProgress { get => (this._migrationProgress = this._migrationProgress ?? new Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.MigrationProgress()); }
    ...
    {
        /// <summary>Migration Progress</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IMigrationProgress MigrationProgress { get; set; }
        /// <summary>Completion Percentage</summary>
        double? MigrationProgressCompletionPercentage { get; set; }
        /// <summary>Progress Message</summary>
        string MigrationProgressMessage { get; set; }
