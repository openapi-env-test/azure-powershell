namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001
{
    ...
    public partial class HealthMonitorTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="HealthMonitor" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthMonitor ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthMonitor).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
