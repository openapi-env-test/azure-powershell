namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001
{
    ...
    public partial class HealthAlert :
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlert,
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlertInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlertInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for Issue</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlertInternal.Issue { get => this._issue; set { {_issue = value;} } }

        /// <summary>Internal Acessors for LastDetected</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlertInternal.LastDetected { get => this._lastDetected; set { {_lastDetected = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlertInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for Raised</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlertInternal.Raised { get => this._raised; set { {_raised = value;} } }

        /// <summary>Internal Acessors for ResolutionUri</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlertInternal.ResolutionUri { get => this._resolutionUri; set { {_resolutionUri = value;} } }

        /// <summary>Internal Acessors for Severity</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlertInternal.Severity { get => this._severity; set { {_severity = value;} } }
