namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001
{
    ...
    public partial class ReplicaSet :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IReplicaSetInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlert[] _healthAlert;

        /// <summary>List of Domain Health Alerts</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlert[] HealthAlert { get => this._healthAlert; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthMonitor[] _healthMonitor;

        /// <summary>List of Domain Health Monitors</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthMonitor[] HealthMonitor { get => this._healthMonitor; }
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IReplicaSetInternal.DomainControllerIPAddress { get => this._domainControllerIPAddress; set { {_domainControllerIPAddress = value;} } }

        /// <summary>Internal Acessors for ExternalAccessIPAddress</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IReplicaSetInternal.ExternalAccessIPAddress { get => this._externalAccessIPAddress; set { {_externalAccessIPAddress = value;} } }

        /// <summary>Internal Acessors for HealthAlert</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlert[] Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IReplicaSetInternal.HealthAlert { get => this._healthAlert; set { {_healthAlert = value;} } }

        /// <summary>Internal Acessors for HealthLastEvaluated</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IReplicaSetInternal.HealthLastEvaluated { get => this._healthLastEvaluated; set { {_healthLastEvaluated = value;} } }

        /// <summary>Internal Acessors for HealthMonitor</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthMonitor[] Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IReplicaSetInternal.HealthMonitor { get => this._healthMonitor; set { {_healthMonitor = value;} } }

        /// <summary>Internal Acessors for Id</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IReplicaSetInternal.Id { get => this._id; set { {_id = value;} } }

        /// <summary>Internal Acessors for ServiceStatus</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IReplicaSetInternal.ServiceStatus { get => this._serviceStatus; set { {_serviceStatus = value;} } }

        /// <summary>Internal Acessors for VnetSiteId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IReplicaSetInternal.VnetSiteId { get => this._vnetSiteId; set { {_vnetSiteId = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlert) })]
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlert[] HealthAlert { get;  }
        /// <summary>Last domain evaluation run DateTime</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthMonitor) })]
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthMonitor[] HealthMonitor { get;  }
        /// <summary>ReplicaSet Id</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>List of Domain Health Alerts</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthAlert[] HealthAlert { get; set; }
        /// <summary>Last domain evaluation run DateTime</summary>
        global::System.DateTime? HealthLastEvaluated { get; set; }
        /// <summary>List of Domain Health Monitors</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IHealthMonitor[] HealthMonitor { get; set; }
        /// <summary>ReplicaSet Id</summary>
        string Id { get; set; }
        /// <summary>Virtual network location</summary>
        string Location { get; set; }
