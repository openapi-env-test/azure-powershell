...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IReplicaSet[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api202001.IForestTrust[]
Parameter Sets: (All)
Aliases:
