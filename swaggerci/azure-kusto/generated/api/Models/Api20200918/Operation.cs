namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200918
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200918.IOperationInternal
    {
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200918.IOperationDisplayInternal)Display).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200918.IOperationDisplayInternal)Display).Description = value ?? null; }

        /// <summary>For example: read, write, delete.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200918.IOperationDisplayInternal)Display).Operation; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200918.IOperationDisplayInternal)Display).Operation = value ?? null; }

        /// <summary>Friendly name of the resource provider.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200918.IOperationDisplayInternal)Display).Provider; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200918.IOperationDisplayInternal)Display).Provider = value ?? null; }

        /// <summary>The resource type on which the operation is performed.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Origin(Microsoft.Azure.PowerShell.Cmdlets.Kusto.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200918.IOperationDisplayInternal)Display).Resource; set => ((Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api20200918.IOperationDisplayInternal)Display).Resource = value ?? null; }
