namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview
{
    ...
    public partial class RequiredTraffic :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.IRequiredTraffic,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.IRequiredTrafficInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.TrafficDirection? Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.IRequiredTrafficInternal.Direction { get => this._direction; set { {_direction = value;} } }

        /// <summary>Internal Acessors for Fqdn</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.IRequiredTrafficInternal.Fqdn { get => this._fqdn; set { {_fqdn = value;} } }

        /// <summary>Internal Acessors for IP</summary>
        string[] Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.IRequiredTrafficInternal.IP { get => this._iP; set { {_iP = value;} } }

        /// <summary>Internal Acessors for Port</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.IRequiredTrafficInternal.Port { get => this._port; set { {_port = value;} } }

        /// <summary>Internal Acessors for Protocol</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.IRequiredTrafficInternal.Protocol { get => this._protocol; set { {_protocol = value;} } }
