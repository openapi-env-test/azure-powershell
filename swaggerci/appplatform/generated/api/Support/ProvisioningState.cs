...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState Deleted = @"Deleted";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState Deleting = @"Deleting";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState MoveFailed = @"MoveFailed";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState Moved = @"Moved";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState Moving = @"Moving";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState Succeeded = @"Succeeded";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState Updating = @"Updating";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
