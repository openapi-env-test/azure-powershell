...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DeploymentResourceStatus Allocating = @"Allocating";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DeploymentResourceStatus Compiling = @"Compiling";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DeploymentResourceStatus Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DeploymentResourceStatus Running = @"Running";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DeploymentResourceStatus Stopped = @"Stopped";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DeploymentResourceStatus Unknown = @"Unknown";

        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DeploymentResourceStatus Upgrading = @"Upgrading";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DeploymentResourceStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DeploymentResourceStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DeploymentResourceStatus e1, Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.DeploymentResourceStatus e2)
        {
            return !e2.Equals(e1);
        }
