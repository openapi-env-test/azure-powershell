...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform
{
    ...
    public partial class Module
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.HttpPipeline _pipeline;

        /// <summary>the ISendAsync pipeline instance (when proxy is enabled)</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.HttpPipeline _pipelineWithProxy;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.AppPlatformManagementClient ClientAPI { get; set; }
        ...
        private static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Module _instance;

        /// <summary>the singleton of this module class</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Module Instance => Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Module._instance?? (Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Module._instance = new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Module());

        /// <summary>The Name of this module</summary>
        public string Name => @"Az.AppPlatform";
        ...
        public string ResourceId => @"Az.AppPlatform";

        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void AfterCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.HttpPipeline pipeline);

        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void BeforeCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.HttpPipeline pipeline);
        ...
        /// <returns>An instance of Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.HttpPipeline for the remote call.</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.HttpPipeline CreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, string correlationId, string processRecordId, string parameterSetName = null)
        {
            Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.HttpPipeline pipeline = null;
        ...
        {
            /// constructor
            ClientAPI = new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.AppPlatformManagementClient();
            _handler.Proxy = _webProxy;
            _pipeline = new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient()));
            _pipelineWithProxy = new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient(_handler)));
        }
