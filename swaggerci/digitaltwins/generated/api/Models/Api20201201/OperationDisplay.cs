namespace Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20201201
{
    ...
    public partial class OperationDisplay :
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20201201.IOperationDisplay,
        Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20201201.IOperationDisplayInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20201201.IOperationDisplayInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20201201.IOperationDisplayInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20201201.IOperationDisplayInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DigitalTwins.Models.Api20201201.IOperationDisplayInternal.Resource { get => this._resource; set { {_resource = value;} } }
