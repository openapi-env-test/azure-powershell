namespace Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview
{
    ...
    public partial class ResourceProviderOperation :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationInternal
    {

        /// <summary>Backing field for <see cref="Display" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplay _display;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplay Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.ResourceProviderOperationDisplay()); set => this._display = value; }
        ...
        public string DisplayDescription { get => ((Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplayInternal)Display).Description; set => ((Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplayInternal)Display).Description = value ?? null; }

        /// <summary>Type of operation: get, read, delete, etc.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Origin(Microsoft.Azure.PowerShell.Cmdlets.Customproviders.PropertyOrigin.Inlined)]
        public string DisplayOperation { get => ((Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplayInternal)Display).Operation; set => ((Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplayInternal)Display).Operation = value ?? null; }

        /// <summary>Resource provider: Microsoft Custom Providers.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Origin(Microsoft.Azure.PowerShell.Cmdlets.Customproviders.PropertyOrigin.Inlined)]
        public string DisplayProvider { get => ((Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplayInternal)Display).Provider; set => ((Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplayInternal)Display).Provider = value ?? null; }

        /// <summary>Resource on which the operation is performed.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Origin(Microsoft.Azure.PowerShell.Cmdlets.Customproviders.PropertyOrigin.Inlined)]
        public string DisplayResource { get => ((Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplayInternal)Display).Resource; set => ((Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplayInternal)Display).Resource = value ?? null; }

        /// <summary>Internal Acessors for Display</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplay Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationInternal.Display { get => (this._display = this._display ?? new Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.ResourceProviderOperationDisplay()); set { {_display = value;} } }
    ...
    {
        /// <summary>Display metadata associated with the operation.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Customproviders.Models.Api20180901Preview.IResourceProviderOperationDisplay Display { get; set; }
        /// <summary>Description of this operation.</summary>
        string DisplayDescription { get; set; }
        /// <summary>Type of operation: get, read, delete, etc.</summary>
        string DisplayOperation { get; set; }
