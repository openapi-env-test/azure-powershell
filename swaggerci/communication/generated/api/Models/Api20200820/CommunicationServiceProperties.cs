namespace Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820
{
    ...
    public partial class CommunicationServiceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820.ICommunicationServiceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820.ICommunicationServicePropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820.ICommunicationServicePropertiesInternal.HostName { get => this._hostName; set { {_hostName = value;} } }

        /// <summary>Internal Acessors for ImmutableResourceId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820.ICommunicationServicePropertiesInternal.ImmutableResourceId { get => this._immutableResourceId; set { {_immutableResourceId = value;} } }

        /// <summary>Internal Acessors for NotificationHubId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820.ICommunicationServicePropertiesInternal.NotificationHubId { get => this._notificationHubId; set { {_notificationHubId = value;} } }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.ProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820.ICommunicationServicePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820.ICommunicationServicePropertiesInternal.Version { get => this._version; set { {_version = value;} } }
