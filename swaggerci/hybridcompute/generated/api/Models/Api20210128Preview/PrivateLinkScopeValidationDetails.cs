namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210128Preview
{
    ...
    public partial class PrivateLinkScopeValidationDetails :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210128Preview.IPrivateLinkScopeValidationDetailsInternal
    {

        /// <summary>Backing field for <see cref="ConnectionDetail" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210128Preview.IConnectionDetail[] _connectionDetail;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210128Preview.IConnectionDetail[] ConnectionDetail { get => this._connectionDetail; set => this._connectionDetail = value; }
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210128Preview.IPrivateLinkScopeValidationDetailsInternal.Id { get => this._id; set { {_id = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210128Preview.IConnectionDetail) })]
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210128Preview.IConnectionDetail[] ConnectionDetail { get; set; }
        /// <summary>Azure resource Id</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Runtime.Info(
        Required = false,
        ReadOnly = true,
