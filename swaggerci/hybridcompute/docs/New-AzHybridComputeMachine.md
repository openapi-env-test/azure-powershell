...
New-AzHybridComputeMachine -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-LocationDataDistrict <String>] [-LocationDataName <String>] [-PrivateLinkScopeResourceId <String>]
 [-Tag <Hashtable>] [-VMId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
