...
### Update
```
Update-AzConfluentOrganization -Name <String> -ResourceGroupName <String> -Body <IOrganizationResourceUpdate>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-AzConfluentOrganization -InputObject <IConfluentIdentity> -Body <IOrganizationResourceUpdate>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Confluent.Models.Api20200301.IOrganizationResourceUpdate
