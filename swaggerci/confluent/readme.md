...
require:
    ...
    - $(this-folder)/../../../azure-rest-api-specs/specification/confluent/resource-manager/readme.md
try-require:
    - $(this-folder)/../../../azure-rest-api-specs/specification/confluent/resource-manager/readme.powershell.md
```
